...
export class SpeechService {
  ...
  public static async saveRecordingToProject(audioBlob: Blob, filename?: string): Promise<string> {
    ...
    try {
      ...
      const recordings = JSON.parse(localStorage.getItem('projectVoiceRecordings') || '{}');
  ...
  public static async loadRecordingFromProject(filename: string): Promise<Blob | null> {
    try {
      const recordings = JSON.parse(localStorage.getItem('projectVoiceRecordings') || '{}');
  ...
  public static async getAllProjectRecordings(): Promise<{[key: string]: any}> {
    try {
