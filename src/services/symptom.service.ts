...
import {
  Symptom,
  _SERVICE as SymptomCanisterService,
} from '../declarations/symptom/symptom.did';
import {
  createActor as createSymptomActor,
  canisterId as symptomCanisterId,
} from '../declarations/symptom';
...
export class SymptomService extends BaseService<SymptomCanisterService> {
  ...
  public async addSymptom(
    ...
    try {
      ...
      const response = await this.actor.addSymptom(
        principal,
        username,
        symptom,
        historyCanisterId,
