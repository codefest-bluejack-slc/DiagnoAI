import { Activity, AlertCircle, Heart, Brain, Thermometer, Stethoscope, Target, TrendingUp } from 'lucide-react';
...
export const getStepIcon = (step: string) => {
  switch (step) {
    case 'input': return <Stethoscope size={20} />;
    case 'review': return <Target size={20} />;
