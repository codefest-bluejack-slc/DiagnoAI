...
export function useDrag(
  ...
  const getElementPosition = useCallback(
    (element: HTMLElement): Position => {
      ...
      const containerStyle = container
        ...
        : null;
      const paddingTop = containerStyle
        ? parseFloat(containerStyle.paddingTop) || 0
        : 0;
      const paddingLeft = containerStyle
  ...
  const constrainPosition = useCallback(
    (position: Position, element: HTMLElement): Position => {
    ...
    (clientX: number, clientY: number) => {
      ...
      const newPosition = {
        x:
          ...
          containerRect.left -
          paddingLeft -
          dragStateRef.current.dragOffset.x,
        y:
          clientY -
          containerRect.top -
          paddingTop -
          headerOffset -
          dragStateRef.current.dragOffset.y,
      };
